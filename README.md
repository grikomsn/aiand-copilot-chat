<p align="center">
  <img src="https://raw.githubusercontent.com/grikomsn/aiand-copilot-chat/main/assets/cover.jpg" alt="Aiand and GitHub Copilot" width="960">
</p>

<h1 align="center">Aiand for GitHub Copilot Chat</h1>

<p align="center">Use Aiand models directly from the GitHub Copilot Chat model picker in Visual Studio Code.</p>
...
This extension is a native VS Code `LanguageModelChatProvider`. It validates a user-supplied Aiand API key, discovers the models available to that key, and streams OpenAI-compatible chat completions directly from `https://api.aiand.com/v1` into Copilot Chat.

## Highlights

- Direct Aiand integration without a local proxy
...
2. Create an API key in the [Aiand dashboard](https://console.aiand.com/settings/api-keys).
3. Open Copilot Chat, select **Manage Models**, add a **Aiand** provider entry, and enter the key.
4. Choose any model returned by your Aiand account.

To use more than one account or key, add another **Aiand** entry. Each entry keeps its own credential and model list. The legacy **Aiand: Configure API Key** command remains available for command-driven workflows.
...
Unofficial project; not affiliated with Aiand, GitHub, or Microsoft. Aiand usage limits and charges still apply. Licensed under [MIT](LICENSE).
