...
calls ai&. `npm run package` validates the project and creates an installable
VSIX.
...
3. In the new window, add the **ai&** provider entry from Copilot Chat's model
   management UI and enter your API key.
4. Open Copilot Chat and confirm the ai& model group appears.
