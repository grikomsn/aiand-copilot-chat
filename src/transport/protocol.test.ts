...
import { API_BASE, API_ORIGIN, AIAND_ENDPOINTS, extensionUserAgent, aiandHeaders } from "./protocol";
...
test("keeps ai& endpoints and request identity centralized", () => {
  ...
  assert.equal(AIAND_ENDPOINTS.balance, `${API_ORIGIN}/billing/balance`);
