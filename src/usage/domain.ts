...
export interface AiandUsageSnapshot {
...
export function mergeAccountUsage(current: AiandUsageSnapshot, raw: unknown, updatedAt = Date.now()): AiandUsageSnapshot {
...
export function formatUsageRows(snapshot: AiandUsageSnapshot): UsageDisplayRow[] {
